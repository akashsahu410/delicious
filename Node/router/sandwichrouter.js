...
const userapi=require('../api/sandwichapi')

app.post('/get',async (req,res)=>{
    try{
        console.log("inside get of sandwich")
        let data=await userapi.finddata()
        console.log("data get from api in router",data)
        res.status(200).send(data)
    }
    catch(err){
        console.log("error in sandwich router",err)
...
app.post('/delete',async (req,res)=>{
    try{
        console.log("inside delete of sandwich",req.body)
...
app.post('/change',async (req,res)=>{
    try{
        console.log("inside change of sandwich",req.body)
...
app.post('/add',async (req,res)=>{
    try{
        console.log("inside add of sandwich ",req.body)
