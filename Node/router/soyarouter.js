...
const userapi=require('../api/soyaapi')

app.post('/get',async (req,res)=>{
    try{
        console.log("inside get of soya")
        let data=await userapi.finddata()
        console.log("data get from api in router",data)
        res.status(200).send(data)
    }
    catch(err){
        console.log("error in soya router",err)
...
app.post('/delete',async (req,res)=>{
    try{
        console.log("inside delete of soya",req.body)
...
app.post('/change',async (req,res)=>{
    try{
        console.log("inside change of soya",req.body)
...
app.post('/add',async (req,res)=>{
    try{
        console.log("inside add of soya ",req.body)
