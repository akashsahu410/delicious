...
const userapi=require('../api/riceapi')

app.post('/get',async (req,res)=>{
    try{
        console.log("inside get of rice")
        let data=await userapi.finddata()
        console.log("data get from api in router",data)
        res.status(200).send(data)
    }
    catch(err){
        console.log("error in rice router",err)
...
app.post('/delete',async (req,res)=>{
    try{
        console.log("inside delete of rice",req.body)
...
app.post('/change',async (req,res)=>{
    try{
        console.log("inside change of rice ",req.body)
...
app.post('/add',async (req,res)=>{
    try{
        console.log("inside add of rice ",req.body)
