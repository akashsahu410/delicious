...
const userapi=require('../api/shakesapi')

app.post('/get',async (req,res)=>{
    try{
        console.log("inside get of shakes")
        let data=await userapi.finddata()
        console.log("data get from api in router",data)
        res.status(200).send(data)
    }
    catch(err){
        console.log("error in shakes router",err)
...
app.post('/delete',async (req,res)=>{
    try{
        console.log("inside delete of shakes",req.body)
...
app.post('/change',async (req,res)=>{
    try{
        console.log("inside change of shakes ",req.body)
...
app.post('/add',async (req,res)=>{
    try{
        console.log("inside add of shakes ",req.body)
