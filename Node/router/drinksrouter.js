...
const userapi=require('../api/drinksapi')

app.post('/get',async (req,res)=>{
    try{
        console.log("inside get of drinks")
        let data=await userapi.finddata()
        console.log("data get from api in router",data)
        res.status(200).send(data)
    }
    catch(err){
        console.log("error in drinks router",err)
...
app.post('/delete',async (req,res)=>{
    try{
        console.log("inside delete of drinks",req.body)
...
app.post('/change',async (req,res)=>{
    try{
        console.log("inside change of drinks ",req.body)
...
app.post('/add',async (req,res)=>{
    try{
        console.log("inside add of drinks ",req.body)
