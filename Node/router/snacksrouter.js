...
const userapi=require('../api/snacksapi')


app.post('/get',async (req,res)=>{
    try{
        console.log("inside get of  snacks")
        let data=await userapi.finddata()
        console.log("data get from api in router",data)
        res.status(200).send(data)
    }
    catch(err){
        console.log("error in  snacks router",err)
...
app.post('/delete',async (req,res)=>{
    try{
        console.log("inside delete of  snacks",req.body)
...
app.post('/change',async (req,res)=>{
    try{
        console.log("inside change of snacks",req.body)
...
app.post('/add',async (req,res)=>{
    try{
        console.log("inside add of snacks ",req.body)
