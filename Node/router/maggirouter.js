...
const userapi=require('../api/maggiapi')

app.post('/get',async (req,res)=>{
    try{
        console.log("inside get of maggi")
        let data=await userapi.finddata()
        console.log("data get from api in router",data)
        res.status(200).send(data)
    }
    catch(err){
        console.log("error in maggi router",err)
...
app.post('/delete',async (req,res)=>{
    try{
        console.log("inside delete of maggi",req.body)
...
app.post('/change',async (req,res)=>{
    try{
        console.log("inside change of maggi ",req.body)
...
app.post('/add',async (req,res)=>{
    try{
        console.log("inside add of maggi ",req.body)
